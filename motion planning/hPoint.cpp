...
hPoint hPoint::PointTransform( Quaternion Q )
{
	Quaternion QQ, QR;
	hPoint hp = *this;
	...
	Quaternion qq = QQ*hp*QQ.Conjugate( )+QR*QQ.Conjugate()-QQ*QR.Conjugate();
...
Plane hPoint::PlaneTransform( Quaternion Q )
{
	Quaternion QQ, QR;
	Plane hp = *this;
	...
	Quaternion qq = QQ*hp*QQ.Conjugate( )+QR*M*QQ.Conjugate()-QQ*M*QR.Conjugate();
